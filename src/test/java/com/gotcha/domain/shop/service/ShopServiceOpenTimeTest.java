...
class ShopServiceOpenTimeTest {
    ...
    private ShopService createShopServiceForTest() {
        ...
        // 순서: ShopRepository, KakaoMapClient, ObjectMapper, FavoriteRepository, ReviewRepository,
        //       ReviewImageRepository, ReviewLikeRepository, FileStorageService, CommentRepository, ShopReportRepository
