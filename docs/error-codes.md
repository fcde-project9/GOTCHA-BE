...
| 코드 | HTTP | 메시지 | 설명 |
|------|------|--------|------|
| P001 | 404 | 구독 정보를 찾을 수 없습니다 | 존재하지 않는 구독 |
| P002 | 500 | 푸시 알림 발송에 실패했습니다 | 푸시 발송 오류 |
| P003 | 500 | VAPID 키가 설정되지 않았습니다 | 서버 설정 오류 |
| P004 | 404 | 기기 토큰을 찾을 수 없습니다 | 존재하지 않는 기기 토큰 |
| P005 | 500 | APNS 알림 발송에 실패했습니다 | APNS 발송 오류 |
